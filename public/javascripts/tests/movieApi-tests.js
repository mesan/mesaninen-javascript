...
(function () {
    ...
    _test("getMovies should get movies and use callback", function () {
        // Arrange        
    ...
    _test("getMovies should return deferred with movies", function () {
        // Arrange        
        var data = [{ id: 12, title: "movie1" }],
            callback = sinon.spy();
    ...
    _test("addNewMovie should post movie to server", function () {
        // Arrange        
    ...
    _test("addImage should post data with expected url to server", function () {
        // Arrange        
    ...
    _test("addImage should call callback when server responds", function () {
        // Arrange        
        var data = { id: 12, url: "movie.jpg" },
            callback = sinon.spy();
